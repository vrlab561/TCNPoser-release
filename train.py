...
def parse_args():
    ...
    parser.add_argument("--config", type=str,default='./options/train_config.yaml',  help="Path, where config file is stored")
...
def main():
    ...
    loss_func = PoseJointLoss(configs.loss.loss_type,
                              ...
                              configs.loss.root_euler_weight,
                              configs.loss.rootY_euler_weight
                              ).to(device)
