...
from model.network_cross_channel import HMD_imu_HME_Universe

r"""
from model.network_single_channel import HMD_imu_HME_Universe
"""
...
class HMDIMUModel(nn.Module):
    ...
    def forward(self, sparse_input, do_fk=True):
        ...
        pred_local_pose_aa = utils_transform.sixd2aa(pred_pose.reshape(-1, 6).detach()).reshape(batch_size * time_length, 22 * 3)
        ...
        if do_fk:
            ...
            return pred_pose, pred_shapes, rotation_global_r6d, pred_joint_position,pred_local_pose_aa
        else:
